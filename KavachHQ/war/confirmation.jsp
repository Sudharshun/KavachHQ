        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                 <div class="jumbotron">
                    <h1>Confirmation!</h1>
                    <p>The Data was successfully Stored</p>
                    <p>The Message from Server was <%=responseMsg%></p>
                    <p><a href="index.jsp" class="btn btn-primary btn-lg" role="button">Back to Dashboard</a>
                    </p>
   				 </div>
                </div>
                <!-- /.row -->
