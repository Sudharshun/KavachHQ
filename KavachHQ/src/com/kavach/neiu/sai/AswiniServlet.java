...
public class AswiniServlet extends HttpServlet {
   ...
   if(user!=null){
	   ...
	   healthstatus=req.getParameter("healthstatus");
	    	...
	    	checkin = new Checkin("kavachchkn", latitude,longitude,healthstatus,user.getNickname(),user.getEmail());
	...
	checkin = new Checkin("kavachchkn", latitude,longitude,healthstatus,userName,"dummy@dummy.com");
	
	responseTxt="Now Username:"+userName+",Latitude/Longitude:"+latitude+":"+longitude+",Healthstatus:"+healthstatus+" Saved!!!";
